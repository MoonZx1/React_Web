...
const Experience = () => {
    ...
    return (
        <div className="">
            ...
            <div className={`grid grid-cols-[25%_75%]  rounded px-2 py-6 transition-all ${isMouseEnter['exp1'] ? "bg-gray-300" : ""}`}
                onMouseEnter={() => setIsMouseEnter({ 'exp1': true })}
                onMouseLeave={() => setIsMouseEnter({ 'exp1': false })}
            >
                <div>
                    <FormattedDate isHighlight={isMouseEnter['exp1']}>2024-2025</FormattedDate>
                    <Picture picture={picExp} title="Fullstack" />
                </div>
                <div className="grid gap-y-4">
                    <TitleLink isHighlight={isMouseEnter['exp1']} title="Fullstack" link="https://github.com/MoonZx1/React_Web.git" />
                    <div className="flex gap-4 text-xl" >
                        <Material icon={faGithub} link="https://github.com/MoonZx1/React_Web.git" />
